...
public class SwipeItemLayout extends ViewGroup{
    ...
    public boolean getIsOpen(boolean isOpen) {
        return isOpen;
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {     //重写onLayout
        ...
        if (isOpen) {
            Log.d("122 test", "isOpen");
            mScrollOffset = -mMaxScrollOffset;
        } else {
            Log.d("122 test", "notOpen isOpen,hashCode" + this.hashCode());
        }
...
//    https://blog.csdn.net/lvxiangan/article/details/9309927
    ...
    protected void onVisibilityChanged(View changedView, int visibility) {
        ...
        if (getVisibility() != View.VISIBLE) {
            if (isOpen) mScrollOffset = -mMaxScrollOffset;
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    if (mCaptureItem != null && !mDealByParent) {
                        ...
                        if (touchMode == Mode.TAP) {
                            ...
                            //  1、下拉后，直接close LineItem
                            //  2、只要是open的，就拦截所有它的消息，这样如果点击open的，就只能滑动该capture LineItem
        ...
        public void onTouchEvent(RecyclerView rv, MotionEvent ev) {
            ...
            switch (action) {
                case MotionEvent.ACTION_POINTER_DOWN:
                    ...
                    Log.d("122 test", "action pointer down");
                    break;
                ...
                case MotionEvent.ACTION_UP:
                    if (mCaptureItem != null) {
                        ...
                        if (touchMode == Mode.DRAG) {
                            ...
                            velocityTracker.computeCurrentVelocity(1000, mMaximumVelocity);
                            int xVel = (int) velocityTracker.getXVelocity(mActivePointerId);
                            Log.d("122 test", "line 752 xVel" + xVel);
                            mCaptureItem.fling(xVel);
                        }
                    }
                    cancel();
