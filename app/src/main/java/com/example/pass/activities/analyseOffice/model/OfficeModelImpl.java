package com.example.pass.activities.analyseOffice.model;
...
public class OfficeModelImpl implements IOfficeModel {
    ...
    @Override
    public boolean readOffice(String path, String dir, String name, @NonNull OnProgressListener listener) {
        listener.onStart();
        //判断是哪种Office文件
    ...
    @Override
    public String xmlToString(String path, OnProgressListener listener) {
    ...
    @Override
    public boolean recompileListToXml(String dir, String name, OnProgressListener listener) {
